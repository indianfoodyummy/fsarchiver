...
#define FSA_MAX_RWJOBS           32
#define FSA_MAX_QUEUESIZE        32
#define FSA_MAX_BLKSIZE          921600
#define FSA_DEF_BLKSIZE          524288
#define FSA_MAX_THREAD_OPEN_FD       256
#define FSA_MAX_THREAD_READ_BUFSIZE  64
#define FSA_DEF_THREAD_OPEN_FD       1 
#define FSA_DEF_THREAD_READ_BUFSIZE  4
